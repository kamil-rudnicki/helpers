...
INTO OUTFILE '/tmp/2015-08-11.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n'
from tc_user_log 
...
where end_date >= '2015-08-01' and end_date <= '2015-11-31';"  

#FIX NULL VALUES
cd /tmp/
time sed -i -e's/\\\"//g' -e's/,\\N,/,,/g' 2015-08-11.csv
#sed '2199984q;d' 2015-11.csv 
#head -n 15 /tmp/2015-08-11.csv

#GZIP FILES
time gzip 2015-08-11.csv

#UPLOAD TO GOOGLE CLOUD
time gsutil cp 2015-08-11.csv.gz gs://2015-11/
